...
public class LogicFacade {
    ...
    private static final int CORNERBRICKS = 4; //2 prikker på hver brik i begge hjørner (2*2=4)
...
//DATAMAPPER CRUD
    ...
    public static OrderDetails createOrder(User user, int length, int wide, int heigth) throws OrderException {
